        ...
        return (
            <div className={"sidenav"}>
                ...
                <Nav className="flex-column myNav">
                    <Nav.Link href={"/a/home/" + username} className={"text-info"}><h6 ><AiFillHome/> Home</h6></Nav.Link>
                    <Nav.Link href={"/a/lectures/" + username} className={"text-info"}><h6 ><BiTask/> Held lectures</h6></Nav.Link>
                    <Nav.Link href={"/a/homework/" + username} className={"text-info"}><h6 ><GiNetworkBars/> Homework</h6></Nav.Link>
                    <Nav.Link href={"/a/classes/" + username} className={"text-info"}><h6 ><FaRegListAlt/> Classes</h6></Nav.Link>
                    <Nav.Link href={"/a/users/" + username} className={"text-info"}><h6 ><FiUsers/> Users</h6></Nav.Link>
                    <Nav.Link href={"/a/settings/" + username} className={"text-info"}><h6 ><IoSettingsOutline/> Settings</h6></Nav.Link>
                </Nav>
            </div>
        );
